...
import { useCancelOrderMutation } from '../features/orderSlice';
            ...
            <div className="order-menu-wrap">
              ...
              {menuOpen && (
                <div className="order-menu-dropdown">
                  ...
                  {canCancel && (
                    <div className="order-menu-item order-menu-item--danger" disabled={cancelLoading} onClick={handleCancel}>
                      <ChevronRight size={13} /> {cancelLoading ? <LoadingCircle /> : "Cancel Order"}
                    </div>
                  )}
                </div>
              )}
